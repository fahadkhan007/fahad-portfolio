...
const About = () => {
  return (
    <section
      id="about"
      className="min-h-screen px-6 py-20 bg-white dark:bg-gradient-to-br dark:from-gray-900 dark:via-black dark:to-blue-950 transition-colors duration-300 relative overflow-hidden"
    >
      {/* Dark mode background decorations - same as Contact */}
      <div className="absolute top-20 left-10 w-96 h-96 bg-blue-100 dark:bg-blue-900/20 rounded-full mix-blend-multiply dark:mix-blend-soft-light filter blur-3xl opacity-30 dark:opacity-40"></div>
      <div className="absolute bottom-20 right-10 w-96 h-96 bg-purple-100 dark:bg-purple-900/20 rounded-full mix-blend-multiply dark:mix-blend-soft-light filter blur-3xl opacity-30 dark:opacity-40"></div>
